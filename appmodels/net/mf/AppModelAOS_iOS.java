...
public class AppModelAOS_iOS extends AppModelBase {		private AOSApp AOSApp;
	private Home Home;
	
	public AppModelAOS_iOS(TestObject contextTestObject) throws GeneralLeanFtException
	{
		setName("AppModelAOS_iOS");
				AOSApp = new AOSApp(contextTestObject, this);
		Home = new Home(contextTestObject, this);
		rebuildDescriptions();
	}	

			public AOSApp AOSApp() { return AOSApp; }
		public Home Home() { return Home; }

		public class AOSApp extends ApplicationNodeBase
	{
	...
	private YesButton YesButton;
						public AOSApp(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
	...
	public class Home extends ApplicationNodeBase
	{
						...
						public Home(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
					...
					allowButton = new allowButton(this, applicationModel);
		...
		protected com.hp.lft.sdk.mobile.ApplicationDescription createDescription() throws GeneralLeanFtException{
			...
			return description;
				...
				public allowButton allowButton() { return allowButton; }
		
			public class allowButton extends ButtonNodeBase
	{

		
								public allowButton(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

			
			setDisplayName("Allow");
		}
		...
		protected com.hp.lft.sdk.mobile.ButtonDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.mobile.ButtonDescription description = null; 
			try{
				description = new com.hp.lft.sdk.mobile.ButtonDescription.Builder().accessibilityId("Allow").className("Button").mobileCenterIndex(1).text("Allow").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
